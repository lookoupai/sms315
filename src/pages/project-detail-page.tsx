...
import { AlertTriangle, CheckCircle, Clock, ArrowLeft, ExternalLink, User, Globe, Code } from 'lucide-react'
import { getSubmissionsByProjectCode, getProjectByCode } from '../services/database'
import type { Submission, Project } from '../lib/supabase'
    ...
    const fetchProjectData = async () => {
      ...
      try {
        ...
        if (projectData) {
          ...
          // 获取该项目的提交记录
          const submissionsData = await getSubmissionsByProjectCode(code, currentPage, pageSize)
    ...
    if (project) {
      ...
      const structuredData = {
        ...
        "mainEntity": {
          ...
          "applicationSubCategory": "SMS Verification"
        }
      }
